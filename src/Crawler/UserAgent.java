...
/**
 * User agent class that generates a random user agent from a list of widely
 * used user agents.
 *
 * @author Seth Dovgan
 * @version 21JAN19
...
public class UserAgent {
    ...
    // List of widely used user agents
    ...
    /**
     * Returns a random user agent from a list of widely used agents.
